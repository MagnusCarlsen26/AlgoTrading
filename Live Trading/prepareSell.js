(function() {
    ...
    setTimeout(function() {
        ...
        elements.forEach(element => { if(element.textContent.trim().includes('Invested')) {element.querySelector('.style_event__card__actions__button__107m2').click();console.log('ff')} });
        setTimeout(function() {
